...
import { difflib } from "./difflib.js";
...
const unixTimestampRegex = new RegExp(
  `\\b(${_tsd - 1}|${_tsd}|${_tsd + 1})[0-9]{8}([0-9]{3})?\\b`
);
...
getExtensionFile(
  chrome.runtime.getURL("ext_data/features.json"),
  "json",
...
const extractFeatures = function (cookieDat) {
  ...
  console.log("feature config: ", feature_config);
